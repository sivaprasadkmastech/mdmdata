...
-- 			db2 -vf Rollback_MITBusinessServices_MetaData_ZOS.sql
-- 			db2 -vf Rollback_MITBusinessServices_CONSTRAINTS_ZOS.sql
-- 			db2 -vf Rollback_MITBusinessServices_TRIGGERS_ZOS.sql
-- 			db2 -vf Rollback_MITBusinessServices_SETUP_ZOS.sql
--#SET TERMINATOR ;
