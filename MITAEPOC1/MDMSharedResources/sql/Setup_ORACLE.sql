...
-- 			sqlplus userid/password@host @MITCustomModel_SETUP_ORACLE.sql
-- 			sqlplus userid/password@host @MITCustomModel_TRIGGERS_ORACLE.sql
-- 			sqlplus userid/password@host @MITCustomModel_CONSTRAINTS_ORACLE.sql
--			sqlplus userid/password@host @MITCustomModel_ERRORS_100_ORACLE.sql
-- 			sqlplus userid/password@host @MITCustomModel_MetaData_ORACLE.sql
-- 			sqlplus userid/password@host CONFIG_XMLSERVICES_RESPONSE_ORACLE.sql
-- 			sqlplus userid/password@host @MITCustomModel_CODETABLES_ORACLE.sql
ALTER TABLE DB2ADMIN.PERSON
    ADD ( XBand_Level VARCHAR2(250)  );
...
-- 2. Connect to the database.
-- 3. Run each SQL file as shown below and in the same order.
-- 			sqlplus userid/password@host @MITBusinessServices_SETUP_ORACLE.sql
-- 			sqlplus userid/password@host @MITBusinessServices_TRIGGERS_ORACLE.sql
-- 			sqlplus userid/password@host @MITBusinessServices_CONSTRAINTS_ORACLE.sql
--			sqlplus userid/password@host @MITBusinessServices_ERRORS_100_ORACLE.sql
-- 			sqlplus userid/password@host @MITBusinessServices_MetaData_ORACLE.sql
-- 			sqlplus userid/password@host CONFIG_XMLSERVICES_RESPONSE_ORACLE.sql
-- 			sqlplus userid/password@host @MITBusinessServices_CODETABLES_ORACLE.sql
...
CREATE SEQUENCE DB2ADMIN.GROUPDWLTABLE_ID_SEQ START WITH 2000000 INCREMENT BY 1 MINVALUE 2000000 MAXVALUE 2009999 CACHE 10;
...
INSERT INTO DB2ADMIN.GROUPDWLTABLE (GROUP_DWLTABLE_ID, APPLICATION, GROUP_NAME, DWLTABLE_TP_CD, LAST_UPDATE_DT)
	SELECT DB2ADMIN.GROUPDWLTABLE_ID_SEQ.nextval, 'TCRM', 'XPersonBObjExt', T.DWLTABLE_TP_CD, CURRENT_TIMESTAMP
...
CREATE SEQUENCE DB2ADMIN.V_ELATTR_ID_SEQ START WITH 2000000 INCREMENT BY 1 MINVALUE 2000000 MAXVALUE 2009999 CACHE 10;
...
INSERT INTO DB2ADMIN.V_ELEMENTATTRIBUTE (V_ELEMENT_ATTRB_ID, ATTRIBUTE_TP_CD, APPLICATION, GROUP_NAME, ELEMENT_NAME, EXPIRY_DT, LAST_UPDATE_DT)
   SELECT DB2ADMIN.V_ELATTR_ID_SEQ.nextval, A.ATTRIBUTE_TP_CD, 'TCRM', 'XPersonBObjExt', A.ELEMENT_NAME, A.EXPIRY_DT, CURRENT_TIMESTAMP
